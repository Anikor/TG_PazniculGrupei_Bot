...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;  -- :contentReference[oaicite:0]{index=0}
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;  -- :contentReference[oaicite:1]{index=1}
...
CREATE TABLE `schedule` (
  ...
  CONSTRAINT `schedule_ibfk_1`
    FOREIGN KEY (`group_id`) REFERENCES `groups` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;  -- :contentReference[oaicite:2]{index=2}
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;  -- :contentReference[oaicite:3]{index=3}
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;  -- :contentReference[oaicite:4]{index=4}
